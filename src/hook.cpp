...
//
// Light log-once tracing goes to %TEMP%\mstsfencehook.log when MSTSFENCE_TRACE=1; silent
// otherwise. The connect-time DPI fix (and its diagnostics) lives in rdpedisp.cpp.
...
// ---------------------------------------------------------------------------
// install / uninstall (the work-area clamps)
// ---------------------------------------------------------------------------
